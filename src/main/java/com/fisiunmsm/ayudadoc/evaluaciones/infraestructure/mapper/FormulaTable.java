package com.fisiunmsm.ayudadoc.evaluaciones.infraestructure.mapper;

import org.springframework.data.annotation.Id;
import org.springframework.data.relational.core.mapping.Table;

import com.fisiunmsm.ayudadoc.evaluaciones.domain.model.Formula;
...
public class FormulaTable {
    ...
    public FormulaTable(int id, String codigo, String descripcion, String formula){
        this.id= id;
        this.codigo= codigo;
    ...
    public FormulaTable(int id, String codigo, String descripcion, String formula, int funcionid, String estado,
    ...
    public Formula toDomainModel(){
        return new Formula(id, codigo, descripcion, formula, funcionid, estado, institutoid, departamentoid, 
                        usapesos, restamenor, nummenor, restamayor, nummayor, copiaprimero, copiamenor, 
                        copiamayor, redondeo);
    }

    public Mono<Formula> toMono(){
